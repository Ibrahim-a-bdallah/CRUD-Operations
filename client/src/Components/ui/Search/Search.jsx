...
export default function Search() {
  ...
  return (
    <div className="flex w-4/5 bg-[#090040] text-gray-400 items-center justify-between py-2.5 px-5 mx-auto">
      ...
      <div className="flex items-center gap-2.5">
        <button
          ...
          className={`text-xl ${currentPage === 1 ? 'text-gray-600 cursor-not-allowed' : 'text-gray-400 cursor-pointer hover:text-white'}`}
        >
          <IoIosArrowBack />
        </button>
        ...
        <button
          ...
          className={`text-xl ${currentPage === totalPages ? 'text-gray-600 cursor-not-allowed' : 'text-gray-400 cursor-pointer hover:text-white'}`}
        >
          <IoIosArrowForward />
        </button>
      </div>
